...
import com.cool.request.listener.component.cURLListener;
import com.cool.request.net.CommonOkHttpRequest;
import com.cool.request.net.VersionInfoReport;
       ...
       CoolRequest.initCoolRequest(project).installProviders();
        ...
        WindowManager.getInstance().getFrame(project).addWindowFocusListener(new WindowAdapter() {
            ...
            public void windowGainedFocus(WindowEvent e) {
                ...
                project.getMessageBus().syncPublisher(IdeaTopic.IDEA_FRAME_EVENT_TOPIC).windowGainedFocus(e);
            }

            @Override
            public void windowLostFocus(WindowEvent e) {
                super.windowLostFocus(e);
                project.getMessageBus().syncPublisher(IdeaTopic.IDEA_FRAME_EVENT_TOPIC).windowLostFocus(e);
            }
        });
