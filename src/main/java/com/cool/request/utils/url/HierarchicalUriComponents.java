 ...
 * HierarchicalUriComponents.java is part of Cool Request
 *
 * License: GPL-3.0+
 *
...
final class HierarchicalUriComponents extends UriComponents {
     ...
     */
    HierarchicalUriComponents(String scheme, String fragment, String userInfo,
                              String host, String port, PathComponent path,
                              MultiValueMap<String, String> query, boolean encoded) {
    ...
    private HierarchicalUriComponents(String scheme, String fragment,
                                      String userInfo, String host, String port,
                                      PathComponent path, MultiValueMap<String, String> queryParams,
                                      EncodeState encodeState, UnaryOperator<String> variableEncoder) {
