 ...
 * MigLayout.kt is part of Cool Request
 *
 * License: GPL-3.0+
 *
...
open class MigLayout @JvmOverloads constructor(
    val layoutConstraints: LC = LC(),
    ...
    override fun layoutContainer(parent: Container) {
        synchronized(parent.treeLock) {
            ...
            if (lastSize != newSize) {
                ...
                val win = SwingUtilities.getAncestorOfClass(
                    Window::class.java,
                    containerWrapper!!.component as Component
                ) as? Window
                if (win != null) {
                    if (win.isVisible) {
